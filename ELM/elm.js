	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Congratulations if you can see this text! '),
						A2(
						$elm$html$Html$strong,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Cheers!')
							])),
						$elm$html$Html$text('You will learn more on ELM in the coming lessons.')
					]))
			]));
};
