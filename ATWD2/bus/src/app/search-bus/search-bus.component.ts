...
export class SearchBusComponent implements OnInit {
  ...
  onSubmit(formValue: any): void {
    ...
    if (this.searchType === "By Route") {
      this.url = "http://localhost/ATWD1/Controller.php/" + 'route' + '/'+ 'ROUTE_ID'  + '/'+ formValue['searchKey'];
    } else if (this.searchType === "By Fare") {
      this.url = "http://localhost/ATWD1/Controller.php/" + 'route' + '/'+ 'FULL_FARE'  + '/'+ formValue['searchKey'];
    } else if (this.searchType === "By Start Point") {
      this.url = "http://localhost/ATWD1/Controller.php/" + 'route' + '/'+ 'LOC_START_NAMEE'  + '/'+ formValue['searchKey'];
    } else if (this.searchType === "By End Point") {
      this.url = "http://localhost/ATWD1/Controller.php/" + 'route' + '/'+ 'LOC_END_NAMEE'  + '/'+ formValue['searchKey'];
    }
